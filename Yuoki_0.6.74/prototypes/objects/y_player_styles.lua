...
data.raw.player.player.animations.levelBaddon = {
...
data.raw.player.player.animations.levelCaddon = {
	armors =  {"yi_armor_red"},
	idle =
	{
		layers =
...
data.raw.player.player.animations.levelDaddon = {
	armors =  {"yi_walker_c"},
...
data.raw.player.player.animations.levelEaddon = {

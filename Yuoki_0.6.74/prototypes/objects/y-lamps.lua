data:extend(
{
	...
	{ type = "item", name = "y_lamp_red", place_result = "y_lamp_red",  icon_size = 32, icon =  "__Yuoki__/graphics/entity/lamps/y_lamp_red_icon.png", flags = {"goes-to-quickbar"}, subgroup = "y-lamps", stack_size = 50, order = "2a", default_request_amount = 10, },
	{ type = "item", name = "y_lamp_green", place_result = "y_lamp_green",  icon_size = 32, icon =  "__Yuoki__/graphics/entity/lamps/y_lamp_green_icon.png", flags = {"goes-to-quickbar"}, subgroup = "y-lamps", stack_size = 50, order = "2b", default_request_amount = 10,  },
	{ type = "item", name = "y_lamp_blue", place_result = "y_lamp_blue",  icon_size = 32, icon =  "__Yuoki__/graphics/entity/lamps/y_lamp_blue_icon.png", flags = {"goes-to-quickbar"}, subgroup = "y-lamps", stack_size = 50, order = "2c", default_request_amount = 10,  },
	{ type = "item", name = "y_lamp_yellow", place_result = "y_lamp_yellow",  icon_size = 32, icon =  "__Yuoki__/graphics/entity/lamps/y_lamp_yellow_icon.png", flags = {"goes-to-quickbar"}, subgroup = "y-lamps", stack_size = 50, order = "2d", default_request_amount = 10,  },

...
{  
	...
	{ type = "recipe", name = "yi_armor_gray_recipe", energy_required = 5, 
		...
		enabled = "true", result_count = 1, order="sm-1", subgroup = "y_personal", 
	},		
	{ type = "recipe", name = "yi_armor_red_recipe", energy_required = 5, 
		...
		result = "yi_armor_red", 
		enabled = "true", result_count = 1, order="sm-2", subgroup = "y_personal", 
	},			
	{ type = "recipe", name = "yi_armor_gold_recipe", energy_required = 5, 
		...
		enabled = "true", result_count = 1, order="sm-3", subgroup = "y_personal", 
	},				
	{ type = "recipe", name = "yi_walker_a_recipe", energy_required = 10, 
		...
		result_count = 1, order="sm-4", subgroup = "y_personal", 
	},		
	{ type = "recipe", name = "yi_walker_c_recipe", energy_required = 10, 
		...
		result_count = 1, order="sm-6", subgroup = "y_personal", 
	},		

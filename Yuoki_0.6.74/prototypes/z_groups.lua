...
data:extend({
	...
	{ type="item-group", name="yuoki", icon="__Yuoki__/graphics/icons/yuoki-ind-icon.png", icon_size=64, inventory_order="y", order="yi-a" },
	--YI-Energy, Lamps, Fuel
	{ type="item-group", name="yuoki-energy", icon="__Yuoki__/graphics/icons/yuoki-energy.png", icon_size=64, inventory_order="y", order="yi-b" },
	--YI-Transmutation & Trade
	{ type="item-group", name="yuoki-atomics", icon="__Yuoki__/graphics/icons/yuoki-atomics-icon.png", icon_size=64, inventory_order="y", order="yi-c" },
	--YI-Refinery & Fluids 
	{ type="item-group", name="yuoki_liquids", icon="__Yuoki__/graphics/icons/yuoki-liquids.png", icon_size=64, inventory_order="y", order="yi-d" },
	...
	{ type="item-subgroup", group="yuoki", order="zc", name="y_basement", }, --letzte Zeile nach Tiles

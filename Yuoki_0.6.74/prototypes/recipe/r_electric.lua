...
{	
	...
	-- blocked capaciter
	{
		...
		energy_required = 3.0,
		enabled = "true",
		ingredients = {{"y-battery-single-use3", 3}, {"y-conductive-wire-1", 2 }, {"y-chip-1", 1 },}, 
	...
	-- Tier 1 - Accumulators
	{
		...
		ingredients = {{"y_blocked_capa", 3}, {"y-pure-copper", 4}, {"y-conductive-coil-1", 2},},
	...
	-- Medium T2
	{
		...
		energy_required = 6.0, enabled = "true",
		ingredients = {{"y-accumulator-m", 1}, {"y_structure_electric", 3}, {"y-chip-2", 4}, {"y-crystal-cnd", 1},{"y_rwtechsign", 2},},
	...
	},		
	{
		...
		energy_required = 8.0, enabled = "true",
		ingredients = {{"y-accumulator-b", 1}, {"y_structure_electric", 5}, {"y-chip-2", 4}, {"y-crystal-cnd", 2},{"y_rwtechsign", 5},},
	...
	-- Tier 4 - Accumulators - Crystal	
	{
		...
		ingredients = {{"y_structure_element", 12},{"y_quantrinum_infused", 2}, {"y_crystal2_combined", 20}, {"y_compensator_25", 4}, {"y_rwtechsign", 50},},

...
{  
	...
	{
		type="item", name="ye_science_ultimate",  icon_size = 32, icon = "__Yuoki__/graphics/entity/ultimate_science_icon.png", flags = {"goes-to-quickbar"},
	...
	{
		type="item", name="y_trade_ultimate",  icon_size = 32, icon = "__Yuoki__/graphics/entity/trade_ultimate_icon.png", flags = {"goes-to-quickbar"},

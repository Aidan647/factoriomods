data:extend(
{
	...
	-- fuel-cell-c	
	{ type = "item", name = "y-fuel-cell-c",  icon_size = 32, icon =  "__Yuoki__/graphics/icons/fuel_cell_c.png", flags = {"goes-to-main-inventory"}, subgroup = "y-energy", fuel_category = "chemical", fuel_value = "10GJ", stack_size = 500, default_request_amount = 10,},	
	-- fame recipe
	...
	-- fame	
	{ type = "item", name = "y-fame",  icon_size = 32, icon =  "__Yuoki__/graphics/icons/fame-icon.png", flags = {"goes-to-main-inventory"}, subgroup = "y-stargate-f", stack_size = 10000, default_request_amount = 10,},
	...
	-- stargate itself
	{ type = "item", name = "y-stargate", place_result = "y-stargate",  icon_size = 32, icon =  "__Yuoki__/graphics/icons/laika-gate-icon.png", flags = {"goes-to-main-inventory"}, group = "Yuoki", subgroup = "y-tech", stack_size = 3,},			
	...
	{ type = "recipe", name = "y-fame-gen-recipe", order="a", energy_required = 5.0, enabled = "true", ingredients = {{"y-alien-infuser", 1},{"y-ups-flywheel-b", 1},{"y-unicomp-a2",100}},  
		...
		group = "yuoki", subgroup = "y-tech",
	},					
	-- 40-Users
	{ type = "item", name = "y-fame-gen", place_result = "y-fame-gen",  icon_size = 32, icon =  "__Yuoki__/graphics/entity/thanks-icon.png", flags = {"goes-to-main-inventory"}, group = "Yuoki", subgroup = "y-tech", stack_size = 6,},			

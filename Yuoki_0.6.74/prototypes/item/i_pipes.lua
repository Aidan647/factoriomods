data:extend(
{
	...
	
	{
		...
		group = "yuoki", subgroup = "y-fluid-storage", stack_size = 15, flags = {"goes-to-quickbar"}, order = "tank-a1",
	},
	{
		type = "item",
		name = "y-tank-4500", place_result = "y-tank-4500",
		 icon_size = 32, icon =  "__Yuoki__/graphics/entity/tank-4500-icon.png",
		group = "yuoki", subgroup = "y-fluid-storage", stack_size = 15, flags = {"goes-to-quickbar"}, order = "tank-b1",
	},
	{
		type = "item",
		name = "y-tank-8000", place_result = "y-tank-8000",
		 icon_size = 32, icon =  "__Yuoki__/graphics/entity/tank-8000-icon.png",
		group = "yuoki", subgroup = "y-fluid-storage", stack_size = 15, flags = {"goes-to-quickbar"}, order = "tank-c1",
	},	
	{
		type = "item",
		name = "y-tank-24k", place_result = "y-tank-24k",
		 icon_size = 32, icon =  "__Yuoki__/graphics/entity/tank-48k-icon.png",
		group = "yuoki", subgroup = "y-fluid-storage", stack_size = 5, flags = {"goes-to-quickbar"}, order = "tank-c2",
	},	

	{
		...
		group = "yuoki", subgroup = "y-fluid-storage", stack_size = 5, flags = {"goes-to-quickbar"}, order = "tank-c3",
	},	

data:extend(
{
	...
	--{ type = "item", name = "y-bluegear",  icon_size = 32, icon =  "__Yuoki__/graphics/icons/bluegear-icon.png", flags = {"goes-to-main-inventory"}, subgroup = "y-parts", stack_size = 100, order="p-g1",},
	{
		type = "recipe",
	...
	--{ type = "item", name = "y_structure_element",  icon_size = 32, icon =  "__Yuoki__/graphics/icons/structur_element.png", flags = {"goes-to-main-inventory"}, subgroup = "y-parts", stack_size = 100, order="p-g2",},	
	{
		type = "recipe",
	...
	--{ type = "item", name = "y_structure_vessel",  icon_size = 32, icon =  "__Yuoki__/graphics/icons/vessel_structure_icon.png", flags = {"goes-to-main-inventory"}, subgroup = "y-parts", stack_size = 100, order="p-g3",},
	...
	--[[
	{
		...
		name = "y-basic-t1-mf", stack_size = 50, default_request_amount = 20, 
		 icon_size = 32, icon =  "__Yuoki__/graphics/icons/maschine-frame-t1.png",
	...
	-- basic stage-2 maschine frame
	{
		...
		ingredients = {{"y-conductive-coil-1",2},{"y-conductive-wire-1",8},{"electric-engine-unit",2},{"y_structure_element",3}, {"y-bluegear", 3} },
